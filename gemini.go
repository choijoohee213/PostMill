...
마무리 (중요):
- 글의 마지막은 반드시 읽는 사람에게 던지는 질문으로 끝낸다.
  스레드는 답글이 달린 글을 훨씬 많이 노출시키기 때문이다.
- "다들 어떻게 하고 있어?", "이런 거 쓰는 사람 또 있나?", "다른 좋은 거 알면 알려줘"
  처럼 대답하기 쉬운 질문이 좋다.
- 상품을 사라고 권하는 질문이 아니라, 같은 고민을 하는 사람의 경험을 묻는 질문으로 쓴다.
- 질문은 한 줄이면 충분하다.
