...
- 모든 줄을 같은 어미로 끝내지 마라. "~함", "~임", "~더라", "~거든", "~는데"를 섞고
  말을 끝까지 안 맺어도 된다.
